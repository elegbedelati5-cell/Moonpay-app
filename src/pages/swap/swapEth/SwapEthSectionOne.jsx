    ...
    <div className="bg-[#F9F8FB] pb-1">
      <div className="bg-white px-3 lg:px-0 lg:pt-44 py-12 lg:pb-20 rounded-4xl">
        <div className="container flex flex-col md:gap-6 gap-3">
          <div className="flex lg:items-left lg:justify-start md:justify-center md:items-center">
            <img src="/images/ethereum-2.svg" alt="" className="h-12" />
          </div>
          <h1 className="font-semibold md:text-center lg:text-left lg:text-[56px] text-3xl leading-tight tracking-tight">
            Swap Ethereum seamlessly.
          </h1>
          <p className="text-[#737373] md:text-center lg:text-left lg:text-base text-[13px] font-semibold">
            Swap Ethereum quickly and securely, across multiple chains and
            wallets. It's all there in your MoonPay account.
          </p>
          <div className="flex items-center gap-4 mt-5 lg:mt-9 lg:px-0 md:px-10">
          ...
          <div className="flex lg:flex-row md:flex-row flex-col py-4 gap-2 md:items-center lg:items-center lg:px-0 md:px-10 mt-5">
